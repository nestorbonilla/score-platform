...
const FeatureCard = ({ icon, title, content, index }) => (
  <div className={`flex flex-row p-6 rounded-[20px] ${index !== features.length - 1 ? "mb-6" : "mb-0"} feature-card`}>
    <div className={`text-white w-[64px] h-[64px] rounded-full flex justify-center items-center bg-dimBlue`}>
    ...
    <div className="flex-1 flex flex-col ml-3">
      ...
      <p className="font-poppins font-normal text-dimWhite text-[16px] leading-[24px] className: text-white">
        {content}
      </p>
    </div>
  </div>
